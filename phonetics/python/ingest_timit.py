...
Within Google, use
http://g3doc/company/teams/nlp-corpora/external_corpora
...
from phonetics.python import read_nist_sphere
...
def convert_one_example(sphere_file: str, wav_file: str) -> None:
  ...
  wav_io.write_wav_file(wav_file, samples, sample_rate_hz)

  # TIMIT includes .phn files that gives timestamps and labels of the phonemes
