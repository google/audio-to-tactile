...
from phonetics.python import phone_model
from phonetics.python import phone_util
from phonetics.python import embed_vowel
from phonetics.python import plot
...
def get_phone_net(model_file):
  ...
  if model_file == 'embed_vowel.c':
    ...
    def model_fun(x):
      return model({'observed': sliding_window(x, window_size)})['scores']
