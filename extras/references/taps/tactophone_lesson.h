...
#ifndef AUDIO_TO_TACTILE_EXTRAS_REFERENCES_TAPS_TACTOPHONE_LESSON_H_
#define AUDIO_TO_TACTILE_EXTRAS_REFERENCES_TAPS_TACTOPHONE_LESSON_H_
...
#endif
#endif /* AUDIO_TO_TACTILE_EXTRAS_REFERENCES_TAPS_TACTOPHONE_LESSON_H_ */
