...
#include "src/frontend/carl_frontend_design.h"
...
static void TestDesign() {
  ...
  for (c = 0; c < num_channels; ++c) {
    ...
    ComputeQuadraticRoots(1.0, channel_data->biquad_coeffs.a1,
                          channel_data->biquad_coeffs.a2, poles);
    ComplexDouble zeros[2];
    ComputeQuadraticRoots(channel_data->biquad_coeffs.b0,
                          channel_data->biquad_coeffs.b1,
                          channel_data->biquad_coeffs.b2, zeros);
