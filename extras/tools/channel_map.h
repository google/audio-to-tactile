...
#ifndef AUDIO_TO_TACTILE_EXTRAS_TOOLS_CHANNEL_MAP_H_
#define AUDIO_TO_TACTILE_EXTRAS_TOOLS_CHANNEL_MAP_H_
...
#endif
#endif /* AUDIO_TO_TACTILE_EXTRAS_TOOLS_CHANNEL_MAP_H_ */
