...
#ifndef AUDIO_TO_TACTILE_SRC_PHONETICS_HEXAGON_INTERPOLATION_H_
#define AUDIO_TO_TACTILE_SRC_PHONETICS_HEXAGON_INTERPOLATION_H_
...
#endif
#endif /* AUDIO_TO_TACTILE_SRC_PHONETICS_HEXAGON_INTERPOLATION_H_ */
