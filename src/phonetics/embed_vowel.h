...
#ifndef AUDIO_TO_TACTILE_SRC_PHONETICS_EMBED_VOWEL_H_
#define AUDIO_TO_TACTILE_SRC_PHONETICS_EMBED_VOWEL_H_
...
/* Number of expected channels in `frame`. */
...
#endif
#endif /* AUDIO_TO_TACTILE_SRC_PHONETICS_EMBED_VOWEL_H_ */
