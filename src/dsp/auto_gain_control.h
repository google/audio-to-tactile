...
#ifndef AUDIO_TO_TACTILE_SRC_DSP_AUTO_GAIN_CONTROL_H_
#define AUDIO_TO_TACTILE_SRC_DSP_AUTO_GAIN_CONTROL_H_
...
#endif
#endif /* AUDIO_TO_TACTILE_SRC_DSP_AUTO_GAIN_CONTROL_H_ */
