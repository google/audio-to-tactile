...
#ifndef AUDIO_TO_TACTILE_SRC_DSP_RATIONAL_FACTOR_RESAMPLER_KERNEL_H_
#define AUDIO_TO_TACTILE_SRC_DSP_RATIONAL_FACTOR_RESAMPLER_KERNEL_H_
...
#endif
#endif /* AUDIO_TO_TACTILE_SRC_DSP_RATIONAL_FACTOR_RESAMPLER_KERNEL_H_ */
