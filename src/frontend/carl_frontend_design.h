...
#ifndef AUDIO_TO_TACTILE_SRC_FRONTEND_CARL_FRONTEND_DESIGN_H_
#define AUDIO_TO_TACTILE_SRC_FRONTEND_CARL_FRONTEND_DESIGN_H_
...
struct CarlFrontendChannelData {
  BiquadFilterCoeffs biquad_coeffs;
  int should_decimate;
...
struct CarlFrontendChannelState {
  BiquadFilterState biquad_state;
  float diff_state;
...
#endif
#endif /* AUDIO_TO_TACTILE_SRC_FRONTEND_CARL_FRONTEND_DESIGN_H_ */
