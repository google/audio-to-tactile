 ...
 *                    +-> [LPF] --+
 */
#ifndef AUDIO_TO_TACTILE_SRC_FRONTEND_CARL_FRONTEND_H_
#define AUDIO_TO_TACTILE_SRC_FRONTEND_CARL_FRONTEND_H_
...
#endif
#endif /* AUDIO_TO_TACTILE_SRC_FRONTEND_CARL_FRONTEND_H_ */
