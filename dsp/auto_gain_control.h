...
#ifndef AUDIO_TO_TACTILE_DSP_AUTO_GAIN_CONTROL_H_
#define AUDIO_TO_TACTILE_DSP_AUTO_GAIN_CONTROL_H_
...
/* (Internal method, used while warming up the smoothed power estimate.) */
...
#endif
#endif /* AUDIO_TO_TACTILE_DSP_AUTO_GAIN_CONTROL_H_ */
