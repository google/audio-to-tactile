...
#ifndef AUDIO_TO_TACTILE_SDL_TEXTURE_FROM_RLE_DATA_H_
#define AUDIO_TO_TACTILE_SDL_TEXTURE_FROM_RLE_DATA_H_
 ...
 *
 * This function decompresses data specifying an 8-bit alpha channel and a
 * rectangle. This is returned as a newly created ARGB texture with white color
 * and an SDL_Rect. The texture can be used with SDL_SetTextureColorMod to vary
 * its color. The caller should call SDL_DestroyTexture to release memory when
 * done. On failure, the function prints a message to stderr and returns NULL.
 *
...
#endif
#endif /* AUDIO_TO_TACTILE_SDL_TEXTURE_FROM_RLE_DATA_H_ */
