...
#ifndef AUDIO_TO_TACTILE_FRONTEND_CARL_FRONTEND_DESIGN_H_
#define AUDIO_TO_TACTILE_FRONTEND_CARL_FRONTEND_DESIGN_H_
...
#endif
#endif /* AUDIO_TO_TACTILE_FRONTEND_CARL_FRONTEND_DESIGN_H_ */
