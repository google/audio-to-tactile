...
This repository contains a training game for the 24-channel phonemic codes
described in
...
distinct vibrotactile pattern on a 24-tactor "sleeve" that the user wears.
...
with vinyl bumpers glued to them. To play tactile signals through the tactors,
we used a [Motu 24Ao](http://motu.com/products/avb/24ai-24ao) audio interface
device. The Motu has DB25 D-Sub connectors that output 8 channels each. We
use custom boards to connect to the DB25 D-Sub outputs, amplify them with
[MAX98306 Stereo Amplifiers](https://www.adafruit.com/product/987), and connect
through two ribbon cables to the tactors.
...
3. Put on the sleeve and get ready. Press the spacebar button to start the first trial.
   ...
   ![begin lesson](doc/begin-lesson.png)
...
4. A tactile pattern will play on the sleeve. What does it mean? On the first
   ...
   ![lesson trial](doc/lesson-trial.png)
...
5. After selecting a choice, Tactophone enters a review mode. Here, you can
   ...
   ![lesson review](doc/lesson-review.png)
...
6. After enough trials, the lesson ends. A lesson summary with accuracy and
   ...
   ![lesson done](doc/lesson-done.png)
