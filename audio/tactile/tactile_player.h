...
#ifndef AUDIO_TACTILE_TACTILE_PLAYER_H_
#define AUDIO_TACTILE_TACTILE_PLAYER_H_
 ...
 * samples in interleaved order. The `samples` array must have been allocted
...
#endif
#endif /* AUDIO_TACTILE_TACTILE_PLAYER_H_ */
