 ...
 *
 *
 * Audio-to-tactile frontend, using the CARL filterbank + PCEN.
 *
 ...
 *                    +-> [LPF] --+
 */
#ifndef AUDIO_TACTILE_FRONTEND_CARL_FRONTEND_H_
#define AUDIO_TACTILE_FRONTEND_CARL_FRONTEND_H_
...
#endif
#endif /* AUDIO_TACTILE_FRONTEND_CARL_FRONTEND_H_ */
