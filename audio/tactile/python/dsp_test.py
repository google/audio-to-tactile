...
Tests for audio.tactile.python.dsp.
"""
...
class DspTest(unittest.TestCase):
  ...
  def test_sliding_window_basic(self):
    ...
    out = dsp.sliding_window(data, 3)
    np.testing.assert_array_equal(
        out, [[1, 2, 3], [2, 3, 4], [3, 4, 5], [4, 5, 6], [5, 6, 7], [6, 7, 8]])

    out = dsp.sliding_window(data, 3, hop=2)
    np.testing.assert_array_equal(out, [[1, 2, 3], [3, 4, 5], [5, 6, 7]])

    out = dsp.sliding_window(data, 4, hop=3)
