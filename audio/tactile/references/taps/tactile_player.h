...
#ifndef AUDIO_TACTILE_REFERENCES_TAPS_TACTILE_PLAYER_H_
#define AUDIO_TACTILE_REFERENCES_TAPS_TACTILE_PLAYER_H_
...
#endif
#endif /* AUDIO_TACTILE_REFERENCES_TAPS_TACTILE_PLAYER_H_ */
