...
Tests for audio.tactile.phone_embedding.phone_util.
"""
...
"""))
  ...
  def test_run_in_parallel(self):
    ...
    six.assertCountEqual(self, results, np.cos(np.arange(25)))
...
class DatasetTest(absltest.TestCase):
  ...
  def test_missing_metadata(self):
    ...
    with six.assertRaisesRegex(self, ValueError, 'dataset_metadata missing'):
  ...
  def test_nonfinite(self):
    ...
    with six.assertRaisesRegex(self, ValueError, 'nonfinite value'):
