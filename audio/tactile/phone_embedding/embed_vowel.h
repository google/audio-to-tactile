...
#ifndef AUDIO_TACTILE_PHONE_EMBEDDING_EMBED_VOWEL_H_
#define AUDIO_TACTILE_PHONE_EMBEDDING_EMBED_VOWEL_H_
...
#endif
#endif /* AUDIO_TACTILE_PHONE_EMBEDDING_EMBED_VOWEL_H_ */
